...
public final class XtaSystem {
    ...
    public Map<XtaProcess, VarDecl<RatType>> getRefClocks() {
        return processClockMap.entrySet().stream()
                .map(pair -> Tuple2.of(pair.getKey(), pair.getValue().get(pair.getValue().size() - 1)))
